           ...
           <!--                 
                            <?php
                                ...
                                if(isset($_GET['filtertanggal'])){
                                    ...
                                    $sql = mysqli_query($koneksi,"select * from daftarmerk where tanggal='$tgl'");
                                }else{
            ...
            <div class="container-fluid">
                <div class="row">
                    <?php
                        include '../function/koneksi.php';
                        $koneksi = mysqli_connect('localhost', 'root', '', 'antrian') or die ('Database tidak ditemukan');
                        $query = mysqli_query($koneksi,"SELECT * FROM daftarmerek ORDER BY id_merek ASC");
                    ?>
                    <form action="" method="post">
