		...
		$ekstensi = strtolower(end($a));
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ktp_ukuran < 1044070 && $akta_ukuran < 1044070 && $gambardi_ukuran < 1044070 && $uraiandi_ukuran < 1044070 && $suratpernyataan_ukuran < 1044070 && $pengalihanhak_ukuran < 1044070 && $buktiprioritas_ukuran < 1044070 && $kuasa_ukuran < 1044070){			
					...
					$query = mysqli_query($koneksi, "INSERT INTO daftardi VALUES(NULL, '$namalengkap','$nik', '$alamat','$no_telepon','Desain Industri','$no_pendaftaran','$ktp','$akta','$gambardi','$uraiandi','$suratpernyataan','$pengalihanhak','$buktiprioritas','$kuasa','Belum Terverifikasi','')");
					if($query){
